...
Parser.prototype.requestYoutube = function (cb, id) {
  var self = this
  var part = 'snippet,contentDetails,status,player,statistics'
  var fields = 'items(snippet(title,description,thumbnails,channelId,publishedAt,tags),contentDetails(duration,definition,contentRating),status(embeddable),player(embedHtml),statistics)'
  var url = [
...
Parser.prototype.requestYoutubeChannel = function (cb, channelId) {
  var part = 'snippet'
  var fields = 'items(snippet(title,thumbnails))'
  var url = [
